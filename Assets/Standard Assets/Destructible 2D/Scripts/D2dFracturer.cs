...
namespace Destructible2D
{
	...
	public class D2dFracturer_Editor : D2dEditor<D2dFracturer>
	{
		protected override void OnInspector()
		{
			...
			DrawDefault("maxPoints", "This lets you limit how many points the fracture can use.");
			...
			if (Any(t => t.SplitAfterFracture == true))
			{
				BeginIndent();
					...
					DrawDefault("splitHealThreshold", "This allows you to set the HealThreshold value used when splitting.");
				EndIndent();
			}
