...
namespace Extensions
{
	public static class VectorExtensions
	{
		...
		public static Vector2 MakeSameComponents (this Vector2 v, int componentToUse)
		{
		...
		public static Vector2 MakeSameComponents (this float f)
		{
		...
		public static Vector2 SwapComponents (this Vector2 v)
		{
