...
namespace Extensions
{
	public static class DebugExtensions
	{
		...
		// TODO: Make this function. I need to debug the mouse-wheel delta in the build.
		public static TMP_Text DrawText (Vector3 point, Quaternion rotation, string text)
		{
			return null;
		}

		public static TMP_Text DrawText (string text, Vector3 point, Quaternion rotation)
		{
			return null;
		}
